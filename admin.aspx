  ...
  <body>
    <form id="form1" runat="server">
      ...
      <asp:ImageButton
        ID="ImageButton2"
        runat="server"
        ImageUrl="~/images/New folder (2)/studenticon.jpg"
      ...
      <asp:ImageButton
        ID="ImageButton4"
        runat="server"
        ImageUrl="~/images/New folder (2)/companyicon.jpg"
      ...
      >
        ...
        <Fields>
          ...
          />
          <asp:BoundField
            DataField="CompanyMail"
            HeaderText="CompanyMail"
            SortExpression="CompanyMail"
          />
          <asp:BoundField
            DataField="companypass"
            HeaderText="companypass"
      ...
      <asp:ImageButton
        ID="ImageButton5"
        runat="server"
        ImageUrl="~/images/New folder (2)/jobpost.jpg"
        PostBackUrl="~/jobpost.aspx"
        style="
          z-index: 1;
          left: 1278px;
          top: 255px;
