<%@ Page Language="C#" AutoEventWireup="true" CodeFile="College_home.aspx.cs"
Inherits="College_home" %>
    ...
    <form id="form1" runat="server">
      ...
      >
        ...
        <Fields>
          ...
          <asp:BoundField
            ...
            HeaderText="OpeningDate"
            SortExpression="OpeningDate"
          />
          <asp:BoundField
            DataField="CollegeMail"
            HeaderText="CollegeMail"
            SortExpression="CollegeMail"
          />
          <asp:BoundField
            DataField="collegepass"
            HeaderText="collegepass"
      ...
      >
        ...
        <Fields>
          ...
          />
          <asp:BoundField
            DataField="MasterDegree"
            HeaderText="MasterDegree"
            SortExpression="MasterDegree"
          />
          <asp:BoundField
            DataField="MasterCollege"
            HeaderText="MasterCollege"
            SortExpression="MasterCollege"
          />
          <asp:BoundField
            DataField="MasterPassingYear"
            HeaderText="MasterPassingYear"
            SortExpression="MasterPassingYear"
          />
          <asp:BoundField
            DataField="MasterPercentage"
            HeaderText="MasterPercentage"
            SortExpression="MasterPercentage"
          />
          <asp:BoundField
            DataField="BechlorDegree"
            HeaderText="BechlorDegree"
            SortExpression="BechlorDegree"
          />
          <asp:BoundField
            DataField="BechlorCollege"
            HeaderText="BechlorCollege"
            SortExpression="BechlorCollege"
          />
          <asp:BoundField
            DataField="BechlorPassingYear"
            HeaderText="BechlorPassingYear"
            SortExpression="BechlorPassingYear"
          />
          <asp:BoundField
            DataField="BechlorPercentage"
            HeaderText="BechlorPercentage"
            SortExpression="BechlorPercentage"
          />
          <asp:BoundField
            DataField="InterCollegeName"
            HeaderText="InterCollegeName"
            SortExpression="InterCollegeName"
          />
          <asp:BoundField
            DataField="InterBoard"
            HeaderText="InterBoard"
            SortExpression="InterBoard"
          />
          <asp:BoundField
            DataField="InterPercentage"
            HeaderText="InterPercentage"
            SortExpression="InterPercentage"
          />
          <asp:BoundField
            DataField="InterPassingYear"
            HeaderText="InterPassingYear"
            SortExpression="InterPassingYear"
          />
          <asp:BoundField
            DataField="HighSchoolCollege"
            HeaderText="HighSchoolCollege"
            SortExpression="HighSchoolCollege"
          />
          <asp:BoundField
            DataField="HighSchoolBoard"
            HeaderText="HighSchoolBoard"
            SortExpression="HighSchoolBoard"
          />
          <asp:BoundField
            DataField="HighSchoolPercentage"
            HeaderText="HighSchoolPercentage"
            SortExpression="HighSchoolPercentage"
          />
          <asp:BoundField
            DataField="HighSchoolPassingYear"
            HeaderText="HighSchoolPassingYear"
            SortExpression="HighSchoolPassingYear"
          />
          <asp:BoundField
            DataField="uimg"
            HeaderText="uimg"
      ...
      <asp:ImageButton
        ID="ImageButton2"
        runat="server"
        ImageUrl="~/images/New folder (2)/logout.png"
