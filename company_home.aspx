<%@ Page Language="C#" AutoEventWireup="true" CodeFile="company_home.aspx.cs"
Inherits="company_home" %>
  ...
  <body>
    <form id="form1" runat="server">
      ...
      <asp:Label
        ...
        runat="server"
        ForeColor="#CC0099"
        style="z-index: 1; left: 10px; top: 240px; position: absolute"
        Text="welcome"
      ></asp:Label>
      <asp:Label
        ID="companyid"
      ...
      <table class="style1">
        <tr>
          <td class="style2">CompanyName</td>
        </tr>
        <tr>
          <td class="style4">
            CompanyId<asp:TextBox
              ID="compid"
              runat="server"
              style="
                z-index: 1;
